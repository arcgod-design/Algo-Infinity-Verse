/**
 * python-learning.js
 * Interactivity for the Python Learning page:
...
function initHeroTyping() {
  const el = document.getElementById("typingTextPython");
  if (!el) return;
...
function initExerciseToggles() {
  document.querySelectorAll(".py-exercise-toggle").forEach((btn) => {
...
function initCopyButtons() {
  document.querySelectorAll(".py-code-copy").forEach((btn) => {
...
function initSidebarSpy() {
  const links = document.querySelectorAll(".py-sidebar-nav a");
  const lessons = document.querySelectorAll(".py-lesson");
...
function initProgressTracker() {
  ...
  const bar = document.querySelector(".py-progress-bar");
